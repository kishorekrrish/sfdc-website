...
description: Editable List with files and notify option in Salesforce Lightning (Aura). To build a component which displays a list of records and associated files with an option to edit and notify.
